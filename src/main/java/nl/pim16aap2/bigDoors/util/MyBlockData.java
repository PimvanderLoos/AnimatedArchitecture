...
//	private NMSBlock_Vall                block2;
	...
	public MyBlockData(Material mat, Byte blockByte, CustomCraftFallingBlock_Vall fBlock, double radius, MaterialData matData, NMSBlock_Vall block, boolean canRot, int type)
	{
		this.mat       = mat;
		this.block     = block;
//		this.block2    = null;
