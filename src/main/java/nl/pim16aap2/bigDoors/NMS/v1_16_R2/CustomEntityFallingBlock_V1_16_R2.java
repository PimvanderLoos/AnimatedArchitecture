...
/**
 * v1_16_R2 implementation of {@link CustomEntityFallingBlock_Vall}.
 *
 * @author Pim
 * @see CustomEntityFallingBlock_Vall
 */
public class CustomEntityFallingBlock_V1_16_R2 extends EntityFallingBlock implements CustomEntityFallingBlock_Vall
{
    ...
    public CustomEntityFallingBlock_V1_16_R2(final org.bukkit.World world, final double d0, final double d1,
    ...
    public void spawn()
    {
        ((org.bukkit.craftbukkit.v1_16_R2.CraftWorld) bukkitWorld).getHandle().addEntity(this, SpawnReason.CUSTOM);
    }
