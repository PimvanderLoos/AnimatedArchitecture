...
public class NMSBlock_V1_16_R2 extends net.minecraft.server.v1_16_R2.BlockBase implements NMSBlock_Vall
{
    ...
    public NMSBlock_V1_16_R2(World world, int x, int y, int z, Info blockInfo)
    {
        super(blockInfo);
