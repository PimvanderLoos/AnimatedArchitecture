...
public class NMSBlock_V1_15_R1 extends net.minecraft.server.v1_15_R1.Block implements NMSBlock_Vall
{
    ...
    public NMSBlock_V1_15_R1(World world, int x, int y, int z)
    {
