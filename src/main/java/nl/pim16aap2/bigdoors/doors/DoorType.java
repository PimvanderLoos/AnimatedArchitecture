...
{
    BIGDOOR (0, true, "-BD", "BigDoor", "GENERAL.DOORTYPE.BigDoor", new DoorAttribute[] { DoorAttribute.LOCK,
    ...
    DRAWBRIDGE (1, true, "-DB", "Drawbridge", "GENERAL.DOORTYPE.Drawbridge", new DoorAttribute[] { DoorAttribute.LOCK,
                                                                                                   DoorAttribute.TOGGLE,
                                                                                                   DoorAttribute.INFO,
                                                                                                   DoorAttribute.DELETE,
                                                                                                   DoorAttribute.RELOCATEPOWERBLOCK,
    ...
    PORTCULLIS (2, true, "-PC", "Portcullis", "GENERAL.DOORTYPE.Portcullis", new DoorAttribute[] { DoorAttribute.LOCK,
                                                                                                   DoorAttribute.TOGGLE,
                                                                                                   DoorAttribute.INFO,
                                                                                                   DoorAttribute.DELETE,
                                                                                                   DoorAttribute.RELOCATEPOWERBLOCK,
    ...
    SLIDINGDOOR (4, true, "-SD", "SlidingDoor", "GENERAL.DOORTYPE.SlidingDoor", new DoorAttribute[] { DoorAttribute.LOCK,
                                                                                                      DoorAttribute.TOGGLE,
                                                                                                      DoorAttribute.INFO,
                                                                                                      DoorAttribute.DELETE,
                                                                                                      DoorAttribute.RELOCATEPOWERBLOCK,
    ...
    FLAG (5, true, "-FL", "Flag", "GENERAL.DOORTYPE.Flag", new DoorAttribute[] { DoorAttribute.LOCK,
                                                                                 DoorAttribute.TOGGLE,
                                                                                 DoorAttribute.INFO,
                                                                                 DoorAttribute.DELETE,
                                                                                 DoorAttribute.RELOCATEPOWERBLOCK,
    ...
    GARAGEDOOR (6, true, "-GD", "GarageDoor", "GENERAL.DOORTYPE.GarageDoor", new DoorAttribute[] { DoorAttribute.LOCK,
                                                                                                   DoorAttribute.TOGGLE,
                                                                                                   DoorAttribute.INFO,
                                                                                                   DoorAttribute.DELETE,
                                                                                                   DoorAttribute.RELOCATEPOWERBLOCK,
    ...
    WINDMILL (7, true, "-WM", "Windmill", "GENERAL.DOORTYPE.Windmill", new DoorAttribute[] { DoorAttribute.LOCK,
                                                                                             DoorAttribute.TOGGLE,
                                                                                             DoorAttribute.INFO,
                                                                                             DoorAttribute.DELETE,
                                                                                             DoorAttribute.RELOCATEPOWERBLOCK,
    ...
    private DoorType(final int val, final boolean enabled, final String flag, final String codeName,
