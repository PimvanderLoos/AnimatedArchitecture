...
public class CustomEntityFallingBlock_V1_12_R1 extends net.minecraft.server.v1_12_R1.EntityFallingBlock implements CustomEntityFallingBlock
{
    ...
    public void spawn()
    {
        ((org.bukkit.craftbukkit.v1_12_R1.CraftWorld) bukkitWorld).getHandle().addEntity(this, SpawnReason.CUSTOM);
    }
    ...
    {
        datawatcher.set(CustomEntityFallingBlock_V1_12_R1.d, blockposition);
    }
    ...
    protected void i()
    {
        datawatcher.register(CustomEntityFallingBlock_V1_12_R1.d, BlockPosition.ZERO);
    }
