...
public class SkullCreator_V1_16_R3 extends HeadManager
{
    public SkullCreator_V1_16_R3(JavaPlugin plugin)
    {
        super(plugin);
    }
            ...
            if (!map.contains(name))
            {
                ...
                catch (IllegalStateException e)
                {
                    p.sendMessage(ChatColor
                        .translateAlternateColorCodes('&', "&cError: &3Player not found in mojang database."));
                }
