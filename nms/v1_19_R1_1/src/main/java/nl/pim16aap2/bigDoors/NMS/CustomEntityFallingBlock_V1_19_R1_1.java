 ...
 */
public class CustomEntityFallingBlock_V1_19_R1_1 extends EntityFallingBlock implements CustomEntityFallingBlock
{
    private IBlockData block;

    public CustomEntityFallingBlock_V1_19_R1_1(final org.bukkit.World world, final double d0, final double d1,
                                             final double d2, final IBlockData iblockdata)
    {
        ...
        this.a(new BlockPosition(this.df(), this.dh(), this.dl()));
        spawn();
    }
    ...
    public void k()
    {
        ...
        else
        {
            ...
            f(dd().d(0.9800000190734863D, 1.0D, 0.9800000190734863D));
        }
    }
