...
public interface ICustomCraftFallingBlock
{
     ...
     * @return True if the teleport was successful.
     */
    boolean teleport(final @NotNull Vector3Dd newPosition);
     ...
     */
    void setVelocity(final @NotNull Vector3Dd vector);
     ...
     */
    void setHeadPose(final @NotNull Vector3Dd pose);
     ...
     */
    void setBodyPose(final @NotNull Vector3Dd eulerAngle);
}
