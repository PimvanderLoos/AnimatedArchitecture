...
public interface IChunkManager
{
     ...
     */
    boolean isLoaded(final @NotNull IPWorld world, final @NotNull Vector2Di chunk);
     ...
     */
    ChunkLoadResult load(final @NotNull IPWorld world, final @NotNull Vector2Di chunk);
