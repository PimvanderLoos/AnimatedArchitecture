...
public interface IProtectionCompatManager
{
     ...
     */
    @NotNull
    Optional<String> canBreakBlocksBetweenLocs(final @NotNull IPPlayer player, final @NotNull Vector3Di pos1,
                                               final @NotNull Vector3Di pos2, final @NotNull IPWorld world);
}
