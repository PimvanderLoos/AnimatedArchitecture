...
//                                      final @NotNull Vector3Di max);
     ...
     */
    @NotNull
    ICustomCraftFallingBlock fallingBlockFactory(final @NotNull IPLocation loc, final @NotNull INMSBlock block);
     ...
     */
    @NotNull
    INMSBlock nmsBlockFactory(final @NotNull IPLocation loc);
}
