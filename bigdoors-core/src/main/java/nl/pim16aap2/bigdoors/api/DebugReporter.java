...
public abstract class DebugReporter
{
    ...
    public String getDump()
    {
        return new StringBuilder()
            ...
            .append("Java compiler: ").append(System.getProperty("java.compiler")).append('\n')
            ...
            .append('\n')
            .append("JVM specification name: ").append(System.getProperty("java.vm.specification.name")).append('\n')
            ...
            .append("TMP: ").append(System.getProperty("java.io.tmpdir")).append('\n')
            .append("TMP SQLite: ").append(System.getProperty("org.sqlite.tmpdir")).append('\n')

            .append("Registered Platform: ").append(platform.getClass().getName()).append('\n')
            .toString();
    }
}
