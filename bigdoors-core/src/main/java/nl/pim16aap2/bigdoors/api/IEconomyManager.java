...
public interface IEconomyManager
{
     ...
     */
    boolean buyDoor(@NotNull IPPlayer player, @NotNull IPWorld world, @NotNull DoorType type, int blockCount);
     ...
     */
    @NotNull OptionalDouble getPrice(@NotNull DoorType type, int blockCount);
