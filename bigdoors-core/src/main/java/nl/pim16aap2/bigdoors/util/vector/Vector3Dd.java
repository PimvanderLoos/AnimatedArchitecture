...
public record Vector3Dd(double x, double y, double z) implements Vector3DUtil.IVector3D
{
    ...
    public @NotNull Vector3Di toInteger()
    {
        return Vector3Di.fromDouble(this);
    }

    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    static @NotNull Vector3Dd fromInteger(@NotNull Vector3Di intVec)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd add(final @NotNull Vector3Dd other)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd add(final @NotNull Vector3Di other)
    {
        return new Vector3Dd(other.x(), other.y(), other.z());
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd add(double val)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_, _, _ -> new", pure = true)
    public @NotNull Vector3Dd subtract(double x, double y, double z)
    {
        return add(-x, -y, -z);
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd subtract(final @NotNull Vector3Dd other)
    {
        return new Vector3Dd(other.x, other.y, other.z);
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd subtract(final @NotNull Vector3Di other)
    {
        return new Vector3Dd(other.x(), other.y(), other.z());
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd subtract(double val)
    {
        return add(val, val, val);
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_, _, _ -> new", pure = true)
    public @NotNull Vector3Dd multiply(double x, double y, double z)
    {
        return new Vector3Dd(this.x * x, this.y * y, this.z * z);
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd multiply(@NotNull Vector3Dd other)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd multiply(@NotNull Vector3Di other)
    {
        return multiply(other.x(), other.y(), other.z());
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd multiply(double val)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_, _, _ -> new", pure = true)
    public @NotNull Vector3Dd divide(double x, double y, double z)
    {
        return new Vector3Dd(this.x / x, this.y / y, this.z / z);
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd divide(@NotNull Vector3Dd other)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd divide(@NotNull Vector3Di other)
    {
        return divide(other.x(), other.y(), other.z());
    }
     ...
     */
    @CheckReturnValue @Contract(value = "_ -> new", pure = true)
    public @NotNull Vector3Dd divide(double val)
    {
     ...
     */
    @CheckReturnValue @Contract(value = " -> new", pure = true)
    public @NotNull Vector3Dd normalized()
    {
    ...
    public @NotNull Vector3Dd rotateAroundXAxis(@NotNull Vector3DUtil.IVector3D pivotPoint, double radians)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_, _ -> new", pure = true)
    public @NotNull Vector3Dd rotateAroundYAxis(@NotNull Vector3DUtil.IVector3D pivotPoint, double radians)
    {
     ...
     */
    @CheckReturnValue @Contract(value = "_, _ -> new", pure = true)
    public @NotNull Vector3Dd rotateAroundZAxis(@NotNull Vector3DUtil.IVector3D pivotPoint, double radians)
    {
