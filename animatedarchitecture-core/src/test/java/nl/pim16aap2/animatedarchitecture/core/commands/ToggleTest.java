...
class ToggleTest
{
    ...
    void init()
    {
        ...
        Mockito.when(structureToggleRequestFactory.create(
                Mockito.any(),
                Mockito.any(),
                Mockito.any(),
                Mockito.any(),
                Mockito.nullable(Double.class),
                Mockito.anyBoolean(),
                Mockito.anyBoolean(),
                Mockito.any(),
                Mockito.any()))
        ...
        structureToggleRequestBuilder = new StructureAnimationRequestBuilder(
            structureToggleRequestFactory,
            messageableServer,
            Mockito.mock(IPlayerFactory.class),
            Mockito.mock(IConfig.class)
        );

        Mockito.when(factory.newToggle(
                Mockito.any(ICommandSender.class),
                Mockito.any(StructureActionType.class),
                Mockito.any(AnimationType.class),
                Mockito.nullable(Double.class),
                Mockito.anyBoolean(),
        ...
        throws Exception
    {
        ...
        final Set<StructureRetriever> toggledStructures =
            Mockito.mockingDetails(structureToggleRequestFactory)
                .getInvocations()
                .stream()
