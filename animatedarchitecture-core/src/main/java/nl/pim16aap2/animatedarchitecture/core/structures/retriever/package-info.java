 ...
 * point is the {@link nl.pim16aap2.animatedarchitecture.core.structures.retriever.StructureRetrieverFactory} class,
 * which can be used to create instances of
 * {@link nl.pim16aap2.animatedarchitecture.core.structures.retriever.StructureRetriever} and
 * {@link nl.pim16aap2.animatedarchitecture.core.structures.retriever.StructureFinder}. An instance of the factory can
 * be obtained using
 ...
 * utility methods for retrieving structures from the database. For example, when retrieving a structure with name
 * "MyStructure", you can obtain the retriever using the
 * {@link nl.pim16aap2.animatedarchitecture.core.structures.retriever.StructureRetrieverFactory#of(String)}. The
 ...
 * {@link nl.pim16aap2.animatedarchitecture.core.structures.retriever.StructureRetrieverFactory.StructureFinderMode}
