 ...
 * {@link nl.pim16aap2.animatedarchitecture.core.util.delayedinput.DelayedInputRequest} class represents a single delayed input
 * request, such as a request to a player to input a name or confirmation for a command.
 * <p>
 * The {@link nl.pim16aap2.animatedarchitecture.core.util.delayedinput.DelayedStructureSpecificationInputRequest} class is a
 * subclass of {@link nl.pim16aap2.animatedarchitecture.core.util.delayedinput.DelayedInputRequest} that is specifically designed
