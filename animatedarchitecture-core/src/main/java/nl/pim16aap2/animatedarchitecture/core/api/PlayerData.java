...
@EqualsAndHashCode
@AllArgsConstructor
public final class PlayerData implements IPlayerDataContainer
{
    ...
    public PlayerData(UUID uuid, String name, int structureSizeLimit, int structureCountLimit, long permissionsFlag)
    {
        this.uuid = uuid;
        this.name = name;
