/**
 * This package contains classes responsible for handling the configuration files used by the plugin.
 * <p>
 * The {@link nl.pim16aap2.animatedarchitecture.spigot.core.config.ConfigSpigot} class handles all interactions with the
