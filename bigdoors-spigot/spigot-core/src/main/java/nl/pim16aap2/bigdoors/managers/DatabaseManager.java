...
public final class DatabaseManager extends Restartable
{
     ...
     */
    private DatabaseManager(final @NotNull BigDoorsSpigot plugin, final @NotNull String dbFile)
    {
        super(plugin);
     ...
     */
    @NotNull
    public static DatabaseManager init(final @NotNull BigDoorsSpigot plugin, final @NotNull String dbFile)
    {
        ...
        CompletableFuture.runAsync(
            () ->
            {
                ...
                plugin.getPowerBlockManager().onDoorAddOrRemove(newDoor.getWorld().getUID(),
                                                                new Vector3Di(newDoor.getPowerBlockLoc().getBlockX(),
        ...
        CompletableFuture.runAsync(
            () ->
            {
                ...
                plugin.getPowerBlockManager().onDoorAddOrRemove(door.getWorld().getUID(),
                                                                new Vector3Di(door.getPowerBlockLoc().getBlockX(),
