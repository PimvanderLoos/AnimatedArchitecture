...
public final class ConfigLoader
{
     ...
     */
    private ConfigLoader(final @NotNull BigDoorsSpigot plugin, final @NotNull PLogger logger)
    {
        this.plugin = plugin;
        this.logger = logger;
     ...
     */
    @NotNull
    public static ConfigLoader init(final @NotNull BigDoorsSpigot plugin, final @NotNull PLogger logger)
    {
