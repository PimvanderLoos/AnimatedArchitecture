...
public enum ProtectionCompat
{
    PLOTSQUARED("PlotSquared")
        {
            @Override
            public @Nullable Class<? extends IProtectionCompat> getClass(final String version)
            {
     ...
     */
    public static @Nullable ProtectionCompat getFromName(final String name)
    {
     ...
     */
    public abstract @Nullable Class<? extends IProtectionCompat> getClass(final String version);
}
