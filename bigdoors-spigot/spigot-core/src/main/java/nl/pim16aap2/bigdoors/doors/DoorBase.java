...
public abstract class DoorBase
{
    ...
    protected Vector3Di dimensions;
     ...
     *
     * @return 2 {@link Vector2Di}. Min and Max coordinates of chunks in range.
     */
    @NotNull
    public abstract Vector2Di[] calculateChunkRange();
    ...
    {
        dimensions = new Vector3Di(max.getBlockX() - min.getBlockX(),
