...
public class BigDoorsToolUtilSpigot implements IBigDoorsToolUtil
{
    ...
    private static final NamespacedKey BIG_DOORS_TOOL_KEY = new NamespacedKey(BigDoorsSpigot.get(),
                                                                              "BIG_DOORS_TOOL");

    @Override
    public void giveToPlayer(final IPPlayer player, final String name, final String lore)
    {
    ...
    @Override
    public void removeTool(final IPPlayer player)
    {
        final @Nullable Player spigotPlayer = SpigotAdapter.getBukkitPlayer(player);
        if (spigotPlayer == null)
        {
    ...
    @Override
    public boolean isPlayerHoldingTool(final IPPlayer player)
    {
        final @Nullable Player spigotPlayer = SpigotAdapter.getBukkitPlayer(player);
        if (spigotPlayer == null)
        {
    ...
    public boolean isPlayerHoldingTool(final Player player)
    {
