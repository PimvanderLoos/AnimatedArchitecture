...
public class DoorEventToggleStart extends DoorToggleEvent implements IDoorEventToggleStart
{
     ...
     */
    public DoorEventToggleStart(final @NotNull CompletableFuture<Optional<AbstractDoorBase>> futureDoor,
     ...
     * @param skipAnimation If true, the door will skip the animation and open instantly.
     */
    public DoorEventToggleStart(final long doorUID, final @NotNull DoorActionCause cause,
