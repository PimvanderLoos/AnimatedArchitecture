...
@Singleton
public final class BigDoorsSpigotSubPlatform_V1_19_R1 implements IBigDoorsSpigotSubPlatform
{
    ...
    @Inject
    public BigDoorsSpigotSubPlatform_V1_19_R1(AnimatedBlockHookManager animatedBlockHookManager)
    {
    ...
    {
        animatedBlockFactory = new AnimatedBlockFactory_V1_19_R1(animatedBlockHookManager);
        blockAnalyzer = new BlockAnalyzer_V1_19_R1();
        glowingBlockFactory = new GlowingBlock_V1_19_R1.Factory();
    }
}
