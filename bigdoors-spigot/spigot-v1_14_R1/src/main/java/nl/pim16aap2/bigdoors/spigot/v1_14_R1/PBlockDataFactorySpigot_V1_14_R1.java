...
public class PBlockDataFactorySpigot_V1_14_R1 implements IPBlockDataFactory
{
                                                ...
                                                final float radius, final float startAngle)
    {
        ...
        final @NotNull Block vBlock = bukkitWorld.getBlockAt(startLocation.getBlockX(),
        ...
        final @NotNull IPLocation newFBlockLocation = BigDoors.get().getPlatform().getPLocationFactory()
        ...
        final @NotNull INMSBlock nmsBlock = BigDoors.get().getPlatform().getFallingBlockFactory()
                                                    .nmsBlockFactory(startLocation);
        final @NotNull ICustomCraftFallingBlock fBlock = BigDoors.get().getPlatform().getFallingBlockFactory()
