 ...
 * factory will automatically be used if it is included on the classpath and no other implementation of
 * {@code BackendFactory} (other than the default implementation) is. To specify it more explicitly or to work around an
 * issue where multiple {@code BackendFactory} implementations are on the classpath, you can set the
 * {@code flogger.backend_factory} system property:
 *
 * <ul>
 *   <li>{@code
...
public final class Log4j2BackendFactory extends BackendFactory
{
    ...
    public LoggerBackend create(String loggingClassName)
    {
        ...
        // we can access the methods only available under org.apache.logging.log4j.core.Logger.
